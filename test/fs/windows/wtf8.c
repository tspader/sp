...
UTEST(wtf8, to_wtf16_alloc_null_terminates) {
  SKIP_ON_WASM()
  sp_wide_str_t w = sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("hi"));
...
UTEST(wtf8, to_wtf16_alloc_empty_returns_null) {
  SKIP_ON_WASM()
  sp_wide_str_t w = sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit(""));
...
UTEST(wtf8, to_wtf16_alloc_rejects_invalid) {
  SKIP_ON_WASM()
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xC3")).data, (u16*)SP_NULLPTR);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xC3\x28")).data, (u16*)SP_NULLPTR);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xC0\x80")).data, (u16*)SP_NULLPTR);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xE0\x80\x80")).data, (u16*)SP_NULLPTR);
}

UTEST(wtf8, reject_invalid) {
  SKIP_ON_WASM()
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xC0")).len, 0u);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xC3")).len, 0u);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xC3\x28")).len, 0u);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xE2\x82")).len, 0u);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xC0\x80")).len, 0u);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xE0\x80\x80")).len, 0u);
  EXPECT_EQ(sp_wtf8_to_wtf16_a(sp_mem_get_scratch(), sp_str_lit("\xF0\x80\x80\x80")).len, 0u);
}
