...
static sp_str_t render_value_to_str(sp_fmt_arg_t arg) {
  ...
  sp_io_dyn_mem_writer_init_a(sp_mem_get_scratch(), &io);
  sp_fmt_render_default_a(&io.base, sp_mem_get_scratch(), &arg, SP_NULLPTR);
...
static sp_str_t apply_spec_to_str(const c8* content, sp_fmt_spec_t spec) {
  ...
  sp_fmt_apply_spec_a(&io.base, empty, sp_str_view(content), empty, spec);
  return sp_io_dyn_mem_writer_as_str(&io);
}
...
static void _test_before_lt(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, "<", SP_NULLPTR);
}

static void _test_after_gt(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, ">", SP_NULLPTR);
}

static void _test_render_x(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, "X", SP_NULLPTR);
}

static void _test_transform_upper(sp_io_writer_t* io, sp_mem_t mem, sp_str_t content, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
...
static void _test_before_a(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, "[a", SP_NULLPTR);
  sp_io_write_cstr(&_test_log.base, "ba", SP_NULLPTR);
}

static void _test_after_a(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, "a]", SP_NULLPTR);
  sp_io_write_cstr(&_test_log.base, "aa", SP_NULLPTR);
}

static void _test_before_b(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, "[b", SP_NULLPTR);
  sp_io_write_cstr(&_test_log.base, "bb", SP_NULLPTR);
}

static void _test_after_b(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, "b]", SP_NULLPTR);
  sp_io_write_cstr(&_test_log.base, "ab", SP_NULLPTR);
}

static void _test_render_y(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
...
UTEST(sp_fmt_directive, ordering_bracket_nested) {
  ...
  sp_io_dyn_mem_writer_init_a(sp_mem_get_scratch(), &_test_log);
...
static void _test_render_prefixed(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
...
static void _test_fg_before(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)mem;
...
static void _test_fg_after(sp_io_writer_t* io, sp_mem_t mem, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
  sp_io_write_cstr(io, "</fg>", SP_NULLPTR);
}
...
static void _test_transform_redact(sp_io_writer_t* io, sp_mem_t mem, sp_str_t content, sp_fmt_arg_t* arg, sp_fmt_arg_t* param) {
  (void)arg; (void)param; (void)mem;
...
UTEST(sp_fmt_transform, into_writer_backed_builder) {
  ...
  sp_fmt_io(&w.base, "{.upper}", sp_fmt_cstr("hello"));
